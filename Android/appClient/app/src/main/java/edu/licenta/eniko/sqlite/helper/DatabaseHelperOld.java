...
public class DatabaseHelperOld extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_SENSOR =
            "CREATE TABLE IF NOT EXISTS " + HomeManagementDBContract.SensorEntries.TABLE_NAME + " (" +
                    ...
                    " FOREIGN KEY ("+ HomeManagementDBContract.SensorEntries.COLUMN_NAME_ROOM_ID+") REFERENCES "+
                    HomeManagementDBContract.RoomEntries.TABLE_NAME+" ("+ HomeManagementDBContract.RoomEntries._ID+") "+ COMMA_SEP +
                    " FOREIGN KEY ("+ HomeManagementDBContract.SensorEntries.COLUMN_NAME_VALUE_ID+") REFERENCES "+
    ...
    private static final String SQL_CREATE_SENSOR_TO_MODULE =
            "CREATE TABLE IF NOT EXISTS " + HomeManagementDBContract.SensorToModuleEntries.TABLE_NAME + " (" +
                    ...
                    " FOREIGN KEY ("+ HomeManagementDBContract.SensorToModuleEntries.COLUMN_NAME_MODULE_ID+") REFERENCES "+
                    HomeManagementDBContract.ModuleEntries.TABLE_NAME+" ("+ HomeManagementDBContract.ModuleEntries._ID+") "+ COMMA_SEP +
                    " FOREIGN KEY ("+ HomeManagementDBContract.SensorToModuleEntries.COLUMN_NAME_SENSOR_ID+") REFERENCES "+
    ...
    private static final String SQL_CREATE_VALUE_OF_SENSOR =
            "CREATE TABLE IF NOT EXISTS " + HomeManagementDBContract.ValueToSensorEntries.TABLE_NAME + " (" +
                   ...
                   " FOREIGN KEY ("+ HomeManagementDBContract.ValueToSensorEntries.COLUMN_NAME_SENSOR_ID+") REFERENCES "+
                    HomeManagementDBContract.SensorEntries.TABLE_NAME+" ("+ HomeManagementDBContract.SensorEntries._ID+") "+
                    ");";
